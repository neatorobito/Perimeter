...
import { Fence, PerimeterEvent, PerimeterPlugin, LocationPermissionStatus } from './definitions';
...
export class PerimeterWeb extends WebPlugin implements PerimeterPlugin {
  ...
  addListener( _eventName: string, _listenerFunc: (data: PerimeterEvent) => void): Promise<PluginListenerHandle> & PluginListenerHandle { throw this.unimplemented(errorMessage); }
